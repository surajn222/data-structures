# Binary Search. x is the element to find
# binary_search(array, low, high, x)
# 4. if high >= low:
# 1.  if mid == x: return mid
# 2.  elif mid > x: binary_search(array, low, mid-1, x)
# 3.  elif mid < x: binary_search(array, mid+1, high, x)
# 4. else: return -1
