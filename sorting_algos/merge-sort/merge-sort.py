...
# - 5. if len(unsorted_array) <= 1: return
# - 1. split in 2, left and right
# - 2. call merge_sort for left
# - 3. call merge_sort for right
# - 4. merge_two_sorted_lists

# merge_two_sorted_lists: this is a separate program
