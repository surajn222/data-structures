# Sol1:
# Take the temp variable as the MAX possible variable
# Traverse the array, keep the minimum element in temp variable. Keep comparing, update the minimum.

# Sol2:
# Sort the array, get the first element
