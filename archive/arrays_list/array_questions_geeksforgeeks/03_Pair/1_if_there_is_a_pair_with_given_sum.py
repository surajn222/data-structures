...
# Method 2:
# Sum - first element of array(this is one part of the pair) = second part of the pair(count occurrences of this number = add to a variable. this will happen twice)
# Sum - second element of array(this is one part of the pair) = second part of the pair(count occurrences of this number = add to a variable. this will happen twice)
# Sum - third element of array(this is one part of the pair) = second part of the pair(count occurrences of this number = add to a variable. this will happen twice)
# Sum - fourth element of array(this is one part of the pair) = second part of the pair(count occurrences of this number = add to a variable. this will happen twice)
# O(n)

# Sum = first_element + second_element
# Sum - first_element = second_element
# Sum - first_element(loop) = second_element(count occurrences in the array)
